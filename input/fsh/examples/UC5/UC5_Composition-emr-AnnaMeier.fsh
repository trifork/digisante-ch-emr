Instance: UC5-Composition-emr-AnnaMeier
InstanceOf: ChEmrComposition
Usage: #example
Title: "UC5-Composition-emr-AnnaMeier"
...
* author = Reference(UC5-PractitionerRole-Hausarzt)
...
* section[sectionEmergencyContacts].text.div = "<div xmlns='http://www.w3.org/1999/xhtml'><ul><li>Thomas Meier (Ehemann): +41 79 555 55 66</li></ul></div>"
* section[sectionEmergencyContacts].entry[relatedPerson][0] = Reference(UC5-RelatedPerson-Ehemann)
...
* section[sectionCareTeam].text.div = "<div xmlns='http://www.w3.org/1999/xhtml'><ul><li>Dr. med. UC5 Hausarzt</li></ul></div>"
* section[sectionCareTeam].entry[practitioner][0] = Reference(UC5-Practitioner-Hausarzt)
* section[sectionCareTeam].entry[practitionerRole][0] = Reference(UC5-PractitionerRole-Hausarzt)
...
* section[sectionMedications].text.div = "<div xmlns='http://www.w3.org/1999/xhtml'><ul><li>Aspirin cardio 100 mg, 1-0-0-0 — Koronare Herzkrankheit</li><li>Bilol 5 mg (Bisoprolol), 1-0-0-0 — Koronare Herzkrankheit</li><li>Atorvastatin 40 mg, 1-0-0-0 — Koronare Herzkrankheit</li><li>Pemzek 16 mg (Candesartan), 1-0-0-0 — Koronare Herzkrankheit</li></ul></div>"
* section[sectionMedications].entry[medicationStatementOrRequest][0] = Reference(UC5-MedicationStatement-AspirinCardio)
* section[sectionMedications].entry[medicationStatementOrRequest][+] = Reference(UC5-MedicationStatement-Bilol)
* section[sectionMedications].entry[medicationStatementOrRequest][+] = Reference(UC5-MedicationStatement-Atorvastatin)
* section[sectionMedications].entry[medicationStatementOrRequest][+] = Reference(UC5-MedicationStatement-Pemzek)
...
* section[sectionProblems].text.div = "<div xmlns='http://www.w3.org/1999/xhtml'><ul><li>2018 Chronische koronare Herzkrankheit</li></ul></div>"
* section[sectionProblems].entry[problem][0] = Reference(UC5-Condition-KoronareHerzkrankheit)
